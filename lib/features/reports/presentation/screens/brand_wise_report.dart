...
class BrandWiseReportScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BrandWiseReportScreen> createState() =>
      _BrandWiseReportScreenState();
}
...
class _BrandWiseReportScreenState extends ConsumerState<BrandWiseReportScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final results = await repo.getBrandWiseReport(
  ...
  Future<void> _printPdf() async {
    ...
    await Printing.layoutPdf(
      ...
      name: 'BrandWise_${DateFormat('yyyyMMdd').format(_startDate)}.pdf',
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Brand Wise Report',
