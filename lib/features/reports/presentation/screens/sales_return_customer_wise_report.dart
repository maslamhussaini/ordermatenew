...
class SalesReturnCustomerWiseReportScreen extends ConsumerStatefulWidget {
  const SalesReturnCustomerWiseReportScreen({super.key});

  @override
  ConsumerState<SalesReturnCustomerWiseReportScreen> createState() =>
      _SalesReturnCustomerWiseReportScreenState();
}

class _SalesReturnCustomerWiseReportScreenState
    extends ConsumerState<SalesReturnCustomerWiseReportScreen> {
  ...
  Future<void> _printPdf() async {
    ...
    await Printing.layoutPdf(
      ...
      name: 'SalesReturnCustWise_${DateFormat('yyyyMMdd').format(_startDate)}.pdf',
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Sales Return - Customer Wise',
