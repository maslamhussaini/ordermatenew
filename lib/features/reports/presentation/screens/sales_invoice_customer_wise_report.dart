...
class SalesInvoiceCustomerWiseReportScreen extends ConsumerStatefulWidget {
  const SalesInvoiceCustomerWiseReportScreen({super.key});

  @override
  ConsumerState<SalesInvoiceCustomerWiseReportScreen> createState() =>
      _SalesInvoiceCustomerWiseReportScreenState();
}

class _SalesInvoiceCustomerWiseReportScreenState
    extends ConsumerState<SalesInvoiceCustomerWiseReportScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final results = await repo.getSalesByCustomer(
  ...
  Future<void> _printPdf() async {
    ...
    await Printing.layoutPdf(
      ...
      name: 'SalesInvoiceCustWise_${DateFormat('yyyyMMdd').format(_startDate)}.pdf',
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Sales Invoice - Customer Wise',
