...
class CustomerWiseSalesReportScreen extends ConsumerStatefulWidget {
  const CustomerWiseSalesReportScreen({super.key});

  @override
  ConsumerState<CustomerWiseSalesReportScreen> createState() =>
      _CustomerWiseSalesReportScreenState();
}

class _CustomerWiseSalesReportScreenState
    extends ConsumerState<CustomerWiseSalesReportScreen> {
  ...
  Future<void> _printPdf() async {
    ...
    await Printing.layoutPdf(
      ...
      name: 'CustomerWiseSales_${DateFormat('yyyyMMdd').format(_startDate)}.pdf',
    );
  }
