...
class SalesReturnItemWiseReportScreen extends ConsumerStatefulWidget {
  const SalesReturnItemWiseReportScreen({super.key});

  @override
  ConsumerState<SalesReturnItemWiseReportScreen> createState() =>
      _SalesReturnItemWiseReportScreenState();
}

class _SalesReturnItemWiseReportScreenState
    extends ConsumerState<SalesReturnItemWiseReportScreen> {
  ...
  Future<void> _printPdf() async {
    ...
    await Printing.layoutPdf(
      ...
      name: 'SalesReturnItemWise_${DateFormat('yyyyMMdd').format(_startDate)}.pdf',
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Sales Return - Item Wise',
